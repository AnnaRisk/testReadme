...
public class GeneratedTests extends TestBase2 {
    ...
    void сheckAction() {
        ...
        step("Открыть страницу вакансии", () -> {
            Selenide.open("https://hh.ru/vacancy/55442983?from=vacancy_search_list&hhtmFrom=vacancy_search_list&query=qa");
        });
